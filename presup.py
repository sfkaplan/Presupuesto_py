...
DEFAULT_FILE = Path("presup_py.xlsx")  # dejalo en el repo (misma carpeta que app.py)
SHEET_NAME = "Sheet1"
MILLION = 1_000_000
...
st.subheader("4) Top 10 ítems de mayor monto en 2026")
df_top_2026 = (
...
st.subheader("5) Top 10 ítems con mayor variación porcentual positiva (2026 vs 2025)")
df_pos = df_main.copy()
...
st.subheader("6) Top 10 ítems con mayor variación porcentual negativa (2026 vs 2025)")
df_neg = df_main.copy()
...
st.subheader("7) Ítems que aparecen en 2026 y no existían en 2025")
